...
<c:url var="firstUrl" value="${pageContext.request.contextPath}/image?page=1" />
<c:url var="lastUrl" value="${pageContext.request.contextPath}/image?page=${imageList.totalPages}" />
<c:url var="prevUrl" value="${pageContext.request.contextPath}/image?page=${currentIndex - 1}" />
<c:url var="nextUrl" value="${pageContext.request.contextPath}/image?page=${currentIndex + 1}" />
