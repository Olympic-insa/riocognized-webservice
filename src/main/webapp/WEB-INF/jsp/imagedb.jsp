...
<c:url var="firstUrl" value="${pageContext.request.contextPath}/recognition?page=1" />
<c:url var="lastUrl" value="${pageContext.request.contextPath}/recognition?page=${imageList.totalPages}" />
<c:url var="prevUrl" value="${pageContext.request.contextPath}/recognition?page=${currentIndex - 1}" />
<c:url var="nextUrl" value="${pageContext.request.contextPath}/recognition?page=${currentIndex + 1}" />
                    ...
                    <div class="show" style="margin-top: 30px;text-align: center; vertical-align: middle">
                        <div class='pagination'>
                            <ul class ='pagination'>
                                <c:choose>
                                    ...
                                    <c:choose>
                                        <c:when test="${currentIndex == imageList.totalPages}">
                                        <li class="disabled"><a href="#">&gt;</a></li>
                                        <li class="disabled"><a href="#">&gt;&gt;</a></li>
                                        </c:when>
                                        <c:otherwise>
                        ...
                        <c:if  test="${!empty imageList}">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <c:forEach items="${imageList.content}" var="image">
                                        <tr>
                                            <td>${image.name}</td>
